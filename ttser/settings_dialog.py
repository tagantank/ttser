...
class SettingsDialog(QDialog):
    ...
    def to_settings(self) -> AppSettings:
        ...
        result = AppSettings(
            ...
            min_tokens_before_end=self.settings.min_tokens_before_end,
            line_pause_ms=self.settings.line_pause_ms,
            n_gpu_layers=self.settings.n_gpu_layers,
            codec_follow_backend=self.settings.codec_follow_backend,
